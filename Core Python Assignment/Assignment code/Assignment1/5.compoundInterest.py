...
# This program calculates the compound interest based on the principal amount (p),
# time (T), and rate (R).
...
# result display.
# Note: the formula for compound interest is CI = A - P, where A is the total amount after interest.
