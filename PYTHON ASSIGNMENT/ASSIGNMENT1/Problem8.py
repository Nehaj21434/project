...
# This program converts a given number of
# days into years, weeks, and remaining days.
...
# output
print(f"{Days} days is approximately {years} years, 
      {weeks} weeks, {remaingDays} days.")
